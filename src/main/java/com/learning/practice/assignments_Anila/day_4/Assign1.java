...
import com.learning.practice.assignments_Anila.day_4.objects.assign1.*;
...
public class Assign1 {
    ...
    public static void main(String[] args) {
        ...
        Utils.print(pinguObj.walk());
        Utils.print(pinguObj.speak());

        FlyingPingu obj = new FlyingPingu();
        Utils.print("Flying Pingu : " + obj.fly());

        FlyingAnimal obj2 = new FlyingPingu();
        Utils.print("Flying Animal : "  + obj2.fly());
